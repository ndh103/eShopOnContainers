...
$charts = ("eshop-common", "basket-api","catalog-api", "identity-api", "ordering-api","ordering-backgroundtasks","ordering-signalrhub", "payment-api", "webshoppingagg", "webspa", "webstatus", "webhooks-api", "webhooks-web")
$gateways = ("apigwws")
